...
namespace PlatformerPro
{
	...
	public class SequenceDrivenEnemy : Enemy, IMob
	{
		...
		/// </summary>
		public event System.EventHandler <PhaseEventArgs> PhaseEnter;
		
		/// <summary>
		/// Event for damage.
		/// </summary>
		public event System.EventHandler <PhaseEventArgs> PhaseExit;
		...
		{
			if (PhaseEnter != null) PhaseEnter (this, new PhaseEventArgs (phaseInfo[currentPhase].name));
		}
		...
		{
			if (PhaseExit != null) PhaseExit (this, new PhaseEventArgs (phaseInfo[currentPhase].name));
		}
